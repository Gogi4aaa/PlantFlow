            ...
            >
                ...
                <div className="p-6 border-b border-slate-100 dark:border-white/[0.06]">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="font-bold text-slate-800 dark:text-white text-base tracking-tight">Admin Panel</h1>
                            <p className="text-xs text-slate-400 dark:text-slate-500">PlantFlow System</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-4 py-3 mx-4 mt-4 rounded-xl bg-emerald-50 dark:bg-white/[0.04] border border-emerald-100 dark:border-white/[0.06]">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-slate-800 dark:text-slate-200 truncate">{user?.full_name || 'Administrator'}</p>
                ...
                <nav className="flex-1 p-4 space-y-1 mt-2">
                    <p className="text-[11px] font-semibold text-slate-400 dark:text-slate-600 uppercase tracking-widest px-3 mb-3">Management</p>
                                ...
                                <DropdownMenuContent align="end" className="w-56 bg-white dark:bg-[#1E293B] border-slate-100 dark:border-white/10 text-slate-800 dark:text-slate-200">
                                    <div className="p-3 border-b border-slate-100 dark:border-white/[0.06]">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="px-2 py-1 bg-emerald-100 dark:bg-green-500/10 text-emerald-700 dark:text-green-400 text-[10px] font-bold rounded border border-transparent dark:border-green-500/20 uppercase">Admin</span>
                                        </div>
                                    </div>
